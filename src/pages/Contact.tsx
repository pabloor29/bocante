  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact du restaurant Bocante à L'Isle-sur-la-Sorgue, 130 Av. de la Petite Marine, zone commerciale. Adresse, plan d'accès, horaires d'ouverture à jour et téléphone." />
